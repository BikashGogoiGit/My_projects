        ...
        $buffy .= '<div class="' . $this->get_block_classes() . ' tdb-post-meta" ' . $this->get_block_html_atts() . '>';
            ...
            $buffy .= '<div class="tdb-block-inner td-fix-index">';
                ...
                $buffy .= '<div class="tdb-author-name-wrap">';
                    //rbg $buffy .= '<span class="tdb-author-by">' . $this->get_att( 'author_by' ) . '</span> ';

                    $buffy .= '<a class="tdb-author-name" href="' . $post_author_data['author_url'] . '">' . $post_author_data['author_name'] . '  ৰ দ্বাৰা</a>';
                $buffy .= '</div>';
            $buffy .= '</div>';
